...
choice_level2_1B = Choice.new("After going into the woods you decide to head back home, on the way home you see a ghost (A) Fight Ghost (B) Ignore Ghost", 
{ id: '4A', gameOver?: true, text: "You lose(Dont fight ghost)!"}, 
{ id: '4B', gameOver?: false}, '1B')

choice_level2_2A = Choice.new('Lunch was great! Now what? (A) Go to sleep (B) Take a nap',
 {id: '5A', gameOver?: true, text: 'You sleep, ya lose!'}, 
 {id: '5B', gameOver?: true, text: 'You sleep, ya lose!'}, '2A')

 choice_level3_4B = Choice.new("You ignored that Ghost good! Now what? (A) Go to sleep (B) Take a nap",  
